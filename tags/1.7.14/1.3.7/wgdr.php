...
class WGDR {
	...
	public function init() {
		...
		add_action( 'wp_ajax_dismissed_notice_handler', array( $this, 'ajax_rating_notice_handler' ) );
	...
	public function ask_for_rating_js() {
        ...
        <script type="text/javascript">
            jQuery(document).on('click', '.notice-success .notice-dismiss, .rating-link, .rating-support', function ($) {
                ...
                jQuery('.rating-success-notice').remove();
	...
	public function ask_for_rating_notices() {
		...
		?>
        <div class="notice notice-success is-dismissible rating-success-notice">
            <p>
                ...
                <span><b><?php _e( 'Google AdWords Dynamic Retargeting Plugin', 'woocommerce-google-dynamic-retargeting-tag' ); ?></b></span>
