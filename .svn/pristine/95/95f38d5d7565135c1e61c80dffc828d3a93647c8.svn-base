...
//
//			$wgdrt_fs = fs_dynamic_init( array(
//				'id'                  => '7516',
//				'slug'                => 'woocommerce-google-dynamic-retargeting-tag',
//				'type'                => 'plugin',
//				'public_key'          => 'pk_3d22dcc5d0788d6aa100a22f237be',
//				'is_premium'          => false,
//				'has_addons'          => false,
...
//		add_action( 'admin_notices', array( $this, 'ask_for_rating_notices_if_not_asked_before' ) );
	...
	function wgdr_plugin_admin_init() {
		...
		register_setting( 'wgdr_plugin_options_settings_fields', 'wgdr_plugin_options', array(
			$this,
